        ...
        return(
            <div>
              ...
              <g>
                ...
                />
                        ...
                        <div
                            ...
                            className={
                                ...
                                (this.state.date.getHours()===-1?"transition-effect":"")
                            }
                            style={divStyleHours}>
                        </div>
                        ...
                        <div
                            ...
                            className={
                                ...
                                (this.state.date.getMinutes()===-1?"transition-effect":"")
                            }
                        ...
                        <div
                            ...
                            className={
                                ...
                                (this.state.date.getSeconds()===-1?"transition-effect":"")
                            }
                ...
                {<div className="digital">{this.state.date.toLocaleDateString()}</div>}
            </div>
        );
    }
}
